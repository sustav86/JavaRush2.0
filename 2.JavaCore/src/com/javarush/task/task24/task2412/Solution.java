    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                result = stock1Name.compareTo(stock2Name);
                if (result != 0) return result;

                result = stock2Date.compareTo(stock1Date);
                if (result != 0) return result;

                if (stock1.containsKey("open") && stock2.containsKey("open") && stock1.containsKey("last") && stock2.containsKey("last")) {
                    Double stock1Sum = (Double) stock1.get("open") - (Double) stock1.get("last");
                    Double stock2Sum = (Double) stock2.get("open") - (Double) stock2.get("last");
                    result = stock1Sum.compareTo(stock2Sum);
                }
